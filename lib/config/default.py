...
_C.MODEL.INTERMEDIATE_SIZE = [12, 16]
...
def update_config(cfg):
    ...
    cfg.DATASET.ROOT = '/root/repo/nanxinyu/RelativePosNet/RPR-Pose/data/coco/'#'/root/repo/nanxinyu/RelativePosNet/RPR-Net/data/coco/'
